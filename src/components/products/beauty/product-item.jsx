// File: src/components/products/beauty/product-item.jsx
'use client';
...
const ProductItem = ({ product, prdCenter = false, primary_style = false }) => {
  const { _id, img, title, status, price } = product || {};
        ...
        <div className="tp-product-action-3 tp-product-action-blackStyle">
          <div className="tp-product-action-item-3 d-flex flex-column">
            {isAddedToCart ? (
              <Link
                href="/cart"
                className={`tp-product-action-btn-3 active tp-product-add-cart-btn text-center`}
              >
                <Cart />
